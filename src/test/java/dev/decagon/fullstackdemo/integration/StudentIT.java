package dev.decagon.fullstackdemo.integration;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.github.javafaker.Faker;
import dev.decagon.fullstackdemo.student.Gender;
import dev.decagon.fullstackdemo.student.Student;
import dev.decagon.fullstackdemo.student.StudentRepository;
...
public class StudentIT {
    ...
    void testAddNewStudent() throws Exception {
        ...
        Student student = new Student(
                name,
                String.format("%s@email.com", StringUtils.trimAllWhitespace(name.toLowerCase())),
                Gender.MALE
        );
